@include('Admin.common.admin-style')
	<!--  WRAPPER  -->
	<div class="wrapper">
		
		@include('Admin.common.admin-sidebar')
						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown user-menu">
								<button class="dropdown-toggle nav-link ec-drop" data-bs-toggle="dropdown"
									aria-expanded="false">
									<img src="adminassets/img/user/user.png" class="user-image" alt="User Image" />
								</button>
								<ul class="dropdown-menu dropdown-menu-right ec-dropdown-menu">
									<!-- User image -->
									<li class="dropdown-header">
										<img src="adminassets/img/user/user.png" class="img-circle" alt="User Image" />
